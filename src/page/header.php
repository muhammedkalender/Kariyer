                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item"
                           href="index.php?page=<?= $user->type == 0 ? "profile&user" : "firma&company" ?>=<?= $user->memberId ?>"><?= lang("my_profile") ?></a>
                        ...
                        if (($nc = $user->getNotificationCount())[0]) {
                            if ($nc[1] > 0) {
                                $notificationBadge = '<span class="badge badge-danger">' .$nc[1] . '</span>';
                            }
                        }
                        ?>
                        <a class="dropdown-item" href="index.php?page=bildirimler"><?= lang("notification") ?><?=$notificationBadge?></a>
