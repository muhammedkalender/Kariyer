...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2019 at 06:20 AM
...
(1, 4, 'C# - 101', 'Microsoft Açık Akademi', '0', '0', '1990-11-19', 0, '2019-04-20 16:18:01', '2019-04-20 16:18:01', 0),
(2, 4, 'C# - 101', 'Microsoft Açık Akademi', '0', '0', '0000-00-00', 0, '2019-04-20 16:18:20', '2019-04-20 16:18:20', 0),
(3, 4, 'C# - 101', 'Microsoft Açık Akademi', '0', '0', '0000-00-00', 0, '2019-04-20 16:18:21', '2019-04-20 16:18:21', 0),
(4, 4, 'C# - 101', 'Microsoft Açık Akademi', '0', '0', '0000-00-00', 0, '2019-04-20 16:18:26', '2019-04-20 16:18:26', 0),
(5, 4, 'C# - 101', 'Microsoft Açık Akademi', '0', '0', '1990-11-15', 0, '2019-04-20 16:21:09', '2019-04-20 16:21:09', 0),
(6, 4, 'C# - 101', 'Microsoft Açık Akademi', '0', '0', '1990-11-19', 0, '2019-04-20 16:21:46', '2019-04-20 16:21:46', 0),
(7, 4, 'C++1', '02', 'http://a.com', '03', '1111-11-11', 0, '2019-05-18 10:05:16', '2019-05-18 10:05:16', 0),
(8, 4, 'Java', 'Turkcell Geleceği Yazanlar', 'https://www.test.com', 'Test', '1977-12-13', 0, '2019-05-18 10:06:23', '2019-05-18 10:06:23', 0),
(9, 4, 'Boşlar', 'Ne Oluyor ?', '0', '0', '2019-05-15', 0, '2019-05-18 10:08:41', '2019-05-18 10:08:41', 0),
(10, 4, 'asdasd', 'fff', '0', '0', '1111-11-11', 0, '2019-05-18 10:11:00', '2019-05-18 10:11:00', 0),
(11, 4, 'C++', '02', '', '0', '1111-11-11', 0, '2019-05-18 10:12:33', '2019-05-18 10:12:33', 0),
(12, 4, 'Java11', '022', 'https://www.http.com', '3', '2018-05-21', 0, '2019-05-18 10:15:39', '2019-05-18 10:15:39', 0),
(13, 4, 'C#', 'Microsoft Açık Akademi', '', '', '2019-05-13', 0, '2019-05-18 10:23:17', '2019-05-18 10:23:17', 1),
(14, 5, 'asdas das d', 'asdasd', 'https://www.test.com', 'aas fd ghdhfgh', '2019-05-16', 0, '2019-05-20 01:57:41', '2019-05-20 01:57:41', 1);
...
CREATE TABLE `cv` (
  ...
  `cv_member` int(11) NOT NULL,
  `cv_name` varchar(36) COLLATE utf8_unicode_ci NOT NULL,
  `cv_desc` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
  `cv_file` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `cv_order` int(11) DEFAULT '0',
  `cv_insert` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `cv_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `cv` (`cv_id`, `cv_member`, `cv_name`, `cv_desc`, `cv_file`, `cv_order`, `cv_insert`, `cv_update`, `cv_active`) VALUES
(1, 4, 'Yazılım CVSİ', '', '', 0, '2019-05-19 16:19:42', '2019-05-19 17:06:43', 0),
(2, 4, 'Test İçin1', '9fb168fb62acb5b26e96675712d5b1db.pdf', 'CV Yüklüyorumğğğ2', 0, '2019-05-19 16:26:12', '2019-05-19 17:06:41', 0),
(3, 4, 'Test rreest', '390d232be7dbb92919e6b07ae9e9ca7f.pdf', 'asdasd adfsgdfsg ', 0, '2019-05-19 16:27:11', '2019-05-19 17:06:39', 0),
(4, 4, 'Test rreest1', 'asdasd adfsgdfsg 2', 'df9acd1cb4310470821b02992c717f58.pdf', 0, '2019-05-19 16:27:14', '2019-05-19 17:06:33', 0),
(5, 4, 'asd asd as fas', 'asd asgfdsg dasf asd', '74eb03483a07ac052f63ea4e7fdb932d.pdf', 0, '2019-05-19 16:27:44', '2019-05-19 17:06:35', 0),
(6, 4, 'Yazılım CV', 'Yazılım başvuruları için', 'bfef60358a3d15a68b609bc3c8bb4016.pdf', 0, '2019-05-19 18:55:40', '2019-05-19 18:55:40', 1),
(7, 5, 'Test CV', 'ASDAS GSDF G', '6e6136482dba9d9cd9cdeee011f76701.pdf', 0, '2019-05-20 02:03:11', '2019-05-20 02:03:11', 1);
...
(1, 4, 'Boğaziçi', 'İşletme', '4.00', 4, '2015-05-06', '0000-00-00', 0, '2019-04-20 19:04:33', '2019-05-17 11:53:28', 0),
(2, 4, 'Boğaziçi', 'İşletme', '0', 3, '2015-05-06', '2016-06-07', 0, '2019-04-20 19:05:26', '2019-05-18 12:22:16', 0),
(3, 16, '$name', '$department', '$note', 3, '1997-12-11', '1997-12-11', 4, '2019-04-20 19:13:58', '2019-04-20 19:13:58', 1),
(4, 4, 'Boğaziçi', 'İşletme', '4.00', 5, '2015-05-06', '0000-00-00', 0, '2019-04-20 19:30:04', '2019-05-20 03:25:59', 0),
(5, 4, 'Test', 'Bilgisayar Proğgramcılığı', '3.5', 2, '2000-01-11', '2004-01-12', 0, '2019-05-18 12:10:06', '2019-05-18 12:22:08', 0),
(6, 4, 'Test', 'Bilgisayar Proğgramcılığı', '3.5', 2, '2000-01-11', '2004-01-12', 0, '2019-05-18 12:10:47', '2019-05-18 12:22:11', 0),
(7, 4, 'Test', 'Bilgisayar Proğgramcılığı', '3.5', 2, '2000-01-11', '2004-01-12', 0, '2019-05-18 12:10:50', '2019-05-18 12:22:03', 0),
(8, 4, 'Test', 'Bilgisayar Proğgramcılığı', '3.5', 2, '2000-01-11', '2004-01-12', 0, '2019-05-18 12:10:51', '2019-05-18 12:21:56', 0),
(9, 4, 'Boğaziçi', 'Sistemcilik', '4.3', 5, '1997-11-13', '2005-10-13', 0, '2019-05-18 12:11:45', '2019-05-18 12:21:54', 0),
(10, 4, 'Test', 'aasda', '3.5', 4, '1111-11-13', '4000-04-13', 0, '2019-05-18 12:12:23', '2019-05-18 12:22:01', 0),
(11, 4, 'Test', 'aasda', '3.5', 4, '1111-11-13', '4000-04-13', 0, '2019-05-18 12:12:44', '2019-05-18 12:21:59', 0),
(12, 5, 'as das d', 'as dasf aa', '3', 2, '2019-05-12', '2019-05-30', 0, '2019-05-20 01:58:19', '2019-05-20 01:58:19', 1),
(13, 4, 'İstanbul Gedik Üniversitesi', 'Bilgisayar Programcılığı', '3.5', 3, '2019-09-15', '0000-00-00', 0, '2019-05-20 03:26:43', '2019-05-20 03:26:56', 1);
...
CREATE TABLE `experience` (
  ...
  `experience_start` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `experience_end` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 4, 'Seni1111or Financier', 'Berserker Co.', '0', '2019-04-20', '2020-12-19 00:00:00', 0, '2019-04-20 17:01:03', '2019-04-20 17:01:03', 0),
(2, 4, 'Senior Financier', 'Berserker Co.', '0', '2019-01-12 00:00:00', '2020-12-19 00:00:00', 0, '2019-04-20 17:01:21', '2019-04-20 17:01:21', 0),
(3, 4, 'Senior Financier', 'Berserker Co.', '0', '2019-01-12 00:00:00', '2020-12-19 00:00:00', 0, '2019-04-20 17:06:36', '2019-04-20 17:06:36', 0),
(4, 4, 'Senior Financier', 'Berserker Co.', '0', '2019-01-12 00:00:00', '2020-12-19 00:00:00', 0, '2019-04-20 17:07:01', '2019-04-20 17:07:01', 0),
(5, 4, 'Senior Financier', 'Berserker Co.', '0', '2019-01-12 00:00:00', '2020-12-19 00:00:00', 0, '2019-04-20 17:07:51', '2019-04-20 17:07:51', 0),
(6, 4, 'Senior Financier1', 'Berserker Co.2', 'Açıkjlama3', '1994-01-04', '1995-12-15', 0, '2019-05-18 12:54:31', '2019-05-18 12:54:31', 0),
(7, 4, 'as fd gdf', 'Berserker Co.2', 'asd asdas', '2019-05-09', '2019-05-30', 0, '2019-05-20 01:58:04', '2019-05-20 01:58:04', 0),
(8, 5, 'ds gds gsd', 'fdasfasd ', ' asfadsd', '2019-05-16', '', 0, '2019-05-20 01:58:56', '2019-05-20 01:58:56', 1),
(9, 4, 'C# Yazılım Geliştirici', 'Enmos', '', '2018-12-24', '2019-02-15', 0, '2019-05-20 03:25:41', '2019-05-20 03:25:41', 1);
...
CREATE TABLE `job_adv` (
  ...
  `job_adv_special` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `job_adv` (`job_adv_id`, `job_adv_author`, `job_adv_experience`, `job_adv_title`, `job_adv_count`, `job_adv_type`, `job_adv_sex`, `job_adv_description`, `job_adv_view`, `job_adv_app`, `job_adv_category`, `job_adv_special`, `job_adv_father`, `job_adv_close`, `job_adv_insert`, `job_adv_update`, `job_adv_active`) VALUES
(4, 13, '', 'Junior Mobile Devoloper', 1, 1, 0, '<p style=\"text-align: center;\"><strong>Firmamızın &Ccedil;eşitli Takımlarında &Ccedil;alışacak</strong></p>\r\n<h3 style=\"text-align: center;\">&Ouml;ğrenmeyi Seven</h3>\r\n<h3 style=\"text-align: center;\">Takım &Ccedil;alışmasına Yatkın</h3>\r\n<h3 style=\"text-align: center;\">Pendik - Tuzla Civarı Oturan Ekip Arkadaşları Alınacaktır</h3>', 4, 1, 10034, 0, 0, NULL, '2019-05-20 03:35:28', '2019-05-20 03:58:00', 1),
(5, 13, '', 'Senior Graphic Desinger', 1, 4, 0, '<pre>Firmamızın Grafik Departmanında &ccedil;alışacak minimum<strong><em> 5 Yıl</em></strong> tecr&uuml;beli Grafik Tasarımcı&nbsp; aranıyor.</pre>', 0, 0, 10032, 0, 0, NULL, '2019-05-20 03:38:20', '2019-05-20 03:38:20', 1);
...
INSERT INTO `job_apply` (`job_apply_id`, `job_apply_member`, `job_apply_message`, `job_apply_job_adv_id`, `job_apply_review`, `job_apply_insert`, `job_apply_update`, `job_apply_active`) VALUES
(5, 4, NULL, 1, 1, '2019-05-18 22:16:04', '2019-05-19 00:37:39', 1),
(6, 5, NULL, 1, 0, '2019-05-18 22:16:32', '2019-05-19 00:37:25', 1),
(7, 6, NULL, 1, 1, '2019-05-18 22:17:47', '2019-05-19 00:38:01', 1),
(8, 4, NULL, 1, 1, '2019-05-18 22:18:35', '2019-05-19 00:37:28', 1),
(9, 4, NULL, 4, 0, '2019-05-20 03:41:30', '2019-05-20 03:41:30', 1);
...
CREATE TABLE `member` (
  ...
  `member_military_date` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `member_address` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `member_bd` varchar(32) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `member` (`member_id`, `member_type`, `member_power`, `member_email`, `member_gsm`, `member_fax`, `member_name`, `member_surname`, `member_nick`, `member_email_confirm`, `member_gsm_confirm`, `member_password`, `member_prefix`, `member_description`, `member_website`, `member_picture`, `member_gender`, `member_military`, `member_military_date`, `member_smoke`, `member_special`, `member_ban`, `member_ban_date`, `member_insert`, `member_update`, `member_active`, `member_address`, `member_bd`) VALUES
(2, 0, 1, 'mehmet1212@gmail.com', NULL, NULL, 'Ali', 'Veli', NULL, 1, 1, 'fcf335641870787a2b079cae2c935b19e9ec0c1d', 'FQQWDhiFdelYErRg4NkBzCnDhjRmJS1fBYkdH0PSGY5OeLyvxqBCtGh2KhDn7FU8YdgnndLQq46uWtIe90LvBgmHX6bvWZzgfosBjsBzfyaaj3GSNsAIpWAffsIPzDVG', NULL, NULL, 'avatar.jpg', 0, 0, NULL, 0, 0, 0, NULL, '2019-04-23 20:13:31', NULL, 1, '', ''),
(4, 0, 4, 'muhammedkalender@protonmail.com', '+90 551 945 1680', '444', 'Muhammed', 'Kalender', NULL, 1, 1, 'd50476ad686636a26421b6dc29470f686c859183', 'ToTaGHf6cNIL6lHTSOyiF17DTV3QIU4wCAAh29snMJkh7hjycbVco4dUgbYT6Mmvi45GZxU77C5mmNUJO46EarqJJrRarqmGmtmdV3BKUwD2rBS4qrWQ78JfOZr8G8NY', '<p>&Ouml;ğrenci, Yazılım Meraklısı</p>\n<p>&nbsp;</p>', 'http://www.muhammedkalender.com', '07c547f2287cf2e28f621dae2dbec48b.jpeg', 1, 2, '2021-01-01', 1, 2, 0, NULL, '2019-04-19 16:43:32', NULL, 1, 'İstanbul - Tuzla', '1997-11-13'),
(5, 1, 1, 'mehmet@gmail.com', '', NULL, 'Ali', 'Veli', NULL, 1, 1, '29f9cee4775e8d66ff85c673dbba1398690eb64a', '77jdaaExgLYIq4aD3trS3MMXynSsJaGPJktEapebSHKGyOXNqtLCpXQla8FGMtyyryWv0lcZd89LELG9i0jJKzeVzt391RzJyw1F3FjYRXYdvoYmA3XGtZRNiXIc5AH6', '<p>asd as das da<strong>as dasdasd veli</strong></p>', 'http://test.com', 'd6889134ffcc6170f84a1204cb668abb.jpeg', 0, 0, '2000-01-01', 0, 0, 0, NULL, '2019-04-23 20:00:12', NULL, 1, '', '2008-01-01'),
(6, 1, 1, 'maaehmet@gmail.com', 'qasdas', '', 'Ali Veli', 'Veli', NULL, 1, 1, '649b8dcf6d5c89d2208bd3b4fac28ecd24b09c28', 'k5eE1Zwv8ojE36nYjOjLu9xZkQA88GEEsSOZqFrsmAgD5mHVVYgIZanCmuFHuNQflDdmV7oOGByXgnfoxGJn5Vp2Kt3LuNBmyWYmgkMnC0BEOdNlXhuYSlefNTbTSo9y', '<p>asd as oldumu&nbsp;<strong>ascepppp</strong></p>', '', 'e31a621751d86a2c6f568e4800e2aa80.jpeg', 0, 0, NULL, 0, 0, 0, NULL, '2019-04-23 20:05:25', NULL, 1, '', '2000-01-01'),
...
(11, 1, 1, 'asdasd@gmail.com', NULL, NULL, 'Ali', 'Veli', NULL, 1, 1, '3cc7fa3723b52b1f9ed30136a088929eb4f8f1c2', 'raYekAfaWdKJvCjwzZ9oL3f1RIUeTp3wXFYmNh8XxnBAfSIrXm2EJ4OvF3LTj1BTgC1WtbnjEgZmJHtzNxZUukVJw46fDzCORnRlxXNoq4utpEac9Ev8NMkkowdqPrrl', NULL, NULL, 'avatar.jpg', 0, 0, NULL, 0, 0, 0, NULL, '2019-04-23 21:38:44', NULL, 1, '', ''),
...
(13, 1, 2, 'ekstrasoft@mail.com', '0216 439 1313', '0216 439 1314', 'Ekstra Soft Ltd.', 'Ltd.', NULL, 1, 1, 'a42a3db9282d5ebbb3b891b13c5c58c77d809f9c', 'LmA81iqSm29rMHSIfaNeTfqPMSH4mVzJXN6r8jfxbNoUVXt8nl1falgyThWHaNTHRm7BdmpAgR4zmyg8AM0tGiQuT3BtJg0PRdWzXOfg0G2vmjrzp3vRhKeZFd27NVsL', NULL, 'http://www.ekstrasoft.com', 'd480845cf3d682db5b3f661c1ce8615b.jpeg', 0, 0, NULL, 0, 0, 0, NULL, '2019-05-20 03:31:56', NULL, 1, 'İastanbul / Pendik / Doğu Mah.', '2009-11-13');
...
(2, 4, 'Andrew Jackson1', 'US Presidente2', 'Hero3', 'andrew@gov.com5', '+1 155 552 363 334', '', 0, '2019-04-20 19:55:25', '2019-04-20 19:55:25', 0),
(3, 4, 'Andrew Jackson', 'US Presidente', 'Hero', 'andrew@gov.com', '+1 155 552 363 33', '', 0, '2019-05-17 20:01:09', '2019-05-17 20:01:09', 0),
(4, 4, 'Andrew Jackson', 'US Presidente', 'Hero', 'andrew@gov.com', '+1 155 552 363 33', '', 0, '2019-05-17 20:02:10', '2019-05-17 20:02:10', 0),
(5, 4, 'Ali Baytaç', 'Ğoöülçe', 'İşteksi', 'admin@zmail.com', '+111 1111 11111', '', 0, '2019-05-17 20:05:57', '2019-05-17 20:05:57', 0),
(6, 4, 'asdasd', 'asdasd', 'asdasdas', 'dasd@g.com', 'dasdas', '', 0, '2019-05-17 20:07:02', '2019-05-17 20:07:02', 0),
(7, 4, 'asdasd', 'asdasd', 'asdasdas', 'dasd@g.com', 'dasdas', '', 0, '2019-05-17 20:07:26', '2019-05-17 20:07:26', 0),
(8, 4, 'undefined', 'undefined', 'Hero3', 'asdasd@gmail.com', '+1 155 552 363 334', '', 0, '2019-05-17 20:08:07', '2019-05-17 20:08:07', 0),
(9, 4, 'Andrew Jackson1', 'US Presidente2', 'Hero3', 'andrew@gov.com5', '+1 155 552 363 334', '', 0, '2019-05-17 20:09:13', '2019-05-17 20:09:13', 0),
(10, 4, 'Andrew Jackson1', 'US Presidente2', 'Hero3', 'andrew@gov.com5', '+1 155 552 363 334', '', 0, '2019-05-17 20:09:50', '2019-05-17 20:09:50', 0),
(11, 5, 'aasd asd', 'test asde', 'asdf sdgf sd', 'asdasda@gmail.com', '+1 155 552 363 334', '', 0, '2019-05-20 01:57:26', '2019-05-20 01:57:26', 1),
(12, 4, 'Ali Tekin', 'Tekin Soft', 'Firma Sahibi', 'tekin@gmail.com', '+90 555 5555', '', 0, '2019-05-20 03:28:08', '2019-05-20 03:28:08', 1);
...
(2, 4, 'C#', 3, 0, '2019-04-20 12:05:28', '2019-05-18 10:23:34', 0),
(3, 4, 'C#', 3, 0, '2019-05-17 19:11:00', '2019-05-17 19:11:00', 1),
(4, 4, 'Matlab', 4, 0, '2019-05-17 19:11:16', '2019-05-17 19:15:57', 1),
(5, 4, 'Java', 4, 0, '2019-05-17 19:11:38', '2019-05-17 19:15:47', 1),
(6, 4, 'Android', 2, 0, '2019-05-17 19:12:22', '2019-05-17 19:15:52', 1),
(7, 4, 'C++', 1, 0, '2019-05-17 19:13:19', '2019-05-17 19:15:22', 0),
(8, 4, 'Test', 4, 0, '2019-05-20 01:52:17', '2019-05-20 03:28:31', 0),
(9, 5, 'Test', 2, 0, '2019-05-20 01:53:16', '2019-05-20 01:53:16', 1);
...
(34, 4, '1sI2SNJGOYCLzl9wKJA79tIx86VbsTNY2riw83a1R6uPxtkQ5xOUtHmZLrb4UXra2Oy3wpBI04jOqbpqWnmfvp7AIbMhTnY43iPgcDLgJx9eOOvoUmSxGdAcy5SzsSYd', '5ddWniA6SBsqxuOBz6cHEKrGjpnvpp4CaCOCeVRSdUY0lYk4w4FNFY1zaPol4BMMiReYmduLOY2TmBuB0GMsTChTvVZxepy87bHyCt4LRhhkMEl7tT7VjCdcRrNOmGSt', '::1', '2019-05-16 08:08:26', '2019-05-17 11:39:55', 0),
(35, 4, 'kMw5MowKXSSpRJbpaqQFiBGkWXvSTWqwGFs5x5Jv3tpNafUqKukF4qFiqFrWI54p9iPjWHBRAtchWzF0103gInwEcIauoiEkwyx7fBNu7ULfxFB7TLtG6IADv6Gz6pS1', 'u7tdLejIgi69cBEqQIig4hkXAZtrI9eF3Qtmvd6ae2LgDQq9hcYcfi8wce5PH8TdDvAWkFLFvppRe03MQ1dKXgecGfrz36i6xkk1nzvpVJvcM1fPJuOxE4rxWFswcDzZ', '::1', '2019-05-17 11:39:55', '2019-05-18 09:30:42', 0),
(36, 4, 'LoOttkXoV90vt6iIhrE8SgZJujlICQk8bsXaQpZ6mdOD5Y8Dzg0O1LW11fT2myCiBN7BpNED7XbAgHL6NXXs4LmUrdcDO9kVPmeqfxQiX2c3KQ4XPTVaB06BxOyYM4d4', 'aZAt5qKOxxXnYrXCYLdLF9X5UPSylyQeQrGIp9CrJts9ehidst9OdgPEGIwhRmAw3aMvjFDvUUFTz31MZWpPo1gYiVn7JHH2TyAAFRfOC2cozMywFdcxQW06rrDqoFBp', '::1', '2019-05-18 09:30:42', '2019-05-18 18:10:57', 0),
(37, 4, 'te90gbodgZTOTpNnDUwNWN0M0Lze1ROz6BogQPQDBTREul9JqTwPoZQiUVSsXAvTjDuqFnJyGvawqvKHWt5Fe8nixSiszHn3MuhksntJMOcqb7vIVuIUAXynwQXQaTen', 'kjwEN6fbHFiTQAd1uzlnPRcCwXXQlVQas3jfjj030GsrUdCZl0KOUksfWVn8ASZtEKzM8FoiRha7L9wqCZbOTfiOFJKYdkVHUa8XlekrpmJ8mba8R1NC5aHlcKg3xpnc', '::1', '2019-05-18 18:10:57', '2019-05-18 18:10:58', 0),
(38, 4, '18SXkbTnx06mDTqR4L4bprekMs5f62KTYBStCDwhzEcMjukmGAE8thoopt49tdQmtz5nIsIDRP5j5aSwJ1RLOx8Oxc51GQQzKXs0INE64sqB7CVOBSAxUGRFtFTZtArZ', '0fVgZp0B4iewZNxzksZgtNrNgEf2Xa4CyjecbRVbPVUXrwU6HvDs0VNhM8p6jCP6sHTg2jW7DQ4xUIjVmT4Rw5ELIMfXiLUcLvux7KxMhhCtq7IUSipjCDjVKGXVKMj7', '::1', '2019-05-18 18:10:58', '2019-05-18 20:43:32', 0),
(39, 4, 'h33P2AUTb7sf4DSbD8TMJWBjniCt2gEQWWdSvO6Dv6pXPKooreGVKfchyGicplvx2QOshyYiaenWx3338jXDMfh8SolMoftTT7ZvDjEmAnJqmmSnopHNKOO2w4ofEJOt', 'rziIF7EGu49pS9RdcFanq5YOJOSJwQWJPGUb0jtCD8sQ3Ut9N2wWHIjFaoTimgLHUQaFKXPrRT1XoNEiu72CmzBLSyqBuHZtWQlTen4UI3eLQmKPIenQVnJSx59h8FYy', '::1', '2019-05-18 20:43:32', '2019-05-19 09:58:15', 0),
(40, 4, 'xAw9lwxa5McEDrIU9LZdJWm2bdFpcD9e7Ap8vylg3DpWu25Le1ROZ8FIn6KuesWZoWPSzKSuMya4vkbxcBCg8XCREIIvDlCmyLsXl2sT43ztPVLIwseozUiegtBYWIG8', 'DxHDbjrigUf1ulcXXVLdmqnOAaDPMBTQTdVrnmZbSEuY2cyUo68oUZYlZtzd5p8ZniBMPVbfpGrfpnL9lKsEEdBDHxM3dyvcRlWVVAG6BuJidhtTvCEAiKVZIGLOKT8C', '::1', '2019-05-19 09:58:15', '2019-05-19 18:53:22', 0),
(41, 11, 'o8K7fpIB0yZwUC2q37Fou03Ztbcs4eZ9R5gKH6tQhnpcC6628g5n3mNljujlRa8wyN6Ebk1cDMX8UTATqLLru5wGonaFLkCnYMm1MsApict1lVaLJ0tlOkzx27027SfR', 'jUbrGzu66LMwXymvG9SKYiemhcGriawkXKwdM4gtP9NRknEKvVv4piAYXO0xIhgRveEtRTP5eawdceE6Oq6Xg6KdtT4yfiTErbeLwCgQPVBlpX0yUPpQWUGE331Z6boT', '::1', '2019-05-19 18:53:42', '2019-05-19 18:53:50', 0),
(42, 4, 'rDeh4OVTyg9TldvwY4OMrh6NzIGOWR73AG9fAcqNuQVHEcK3OfILnfx6bNHbaLE0LFt0OGWXqMARQOmLjszgXuOp7RrYKMoZn9OWopAv8P8BvKsLUcrMw3hn2ncrRzXb', 'oLUlPOK05VZFhu5e3ccaAnfk30ie5qjflZ0JVUJeAiDmfEtwmpPW9pBANhB6A72mmWjPblIWSuPzauNZXHHBxfX91J78ZMP1cwRLjUP6TLTjTADojB6QbKywH5hOp9dn', '::1', '2019-05-19 18:54:17', '2019-05-20 00:17:57', 0),
(43, 4, 'yammvNM0nPcCGcOIyrgIo8xtNWED8e7tbZsRNxtg6cijDqIIQKiR6UipCprYrRbctECnkdSN9qbM0dAkJ27MCUTz44KJ5U0Tgaq3jZVh8UGdBD56b9jic7z5HQQfmdH5', 'XRLZ9ddYVGYS0KSfZ16Hm6CuabGQ5faVqcEkCrsYKNiaPqcvPNowRjzPZjYlPe1LoeCEYL8tAEgTZWNcIaUoFTw342TlPY78alfUQnRMcNeMY5ae4HyTZ0c5aCCWPQ8n', '::1', '2019-05-20 00:43:03', '2019-05-20 03:04:35', 0),
(44, 4, 'owK8saGl0xI5yAb30ZLsrMafAMSWq7JBB1kh1kc7QhAQtubEwEjZUH7nX4HFz88hyzyDdRqTNz68ixakmFfHscEfiBKNT8haTYBWnNn9F6rbFHeQZVnGbYICs78hBRuh', 'YmyqdJ0ugzUhyNDGmsgsGC9vdZLiT1Z3dHYYbDXIq7iBDR8LsyUHulus8BsSXXgMvTPMFfbTMqrc2TunUvdJu86fsVO4njgCiVnvaOe1OxQJlD62eIQE8C8G2qb4EofP', '::1', '2019-05-20 03:20:32', '2019-05-20 03:20:46', 0),
(45, 4, 'bfsG1C7RONg8AQqyPGrqXW2ULkfi1pJDFDVpRQbETAWrc5KpUvJ7Boj7DNdhAb4JPYET7Fl5RoJuxim9r6awOFVN83OFA5j4x0n2bJpERUN2DA7CnNsm6fd3IJK8cJL8', '0SfADH93GjQKSizwQWXqWQpkPXGb2Fdq1bTOOyrC9IMMASLLsrVEAHESETMhxtp4Ksyoja6WPTz7dTyIq6wee5nJjCaeZdB7cq9h9J1ShHTruWBRUDSOo6OLg5Vh9dqn', '::1', '2019-05-20 03:20:54', '2019-05-20 03:31:20', 0),
(46, 13, '7T5k57CL7hcuYN3N2yVI2KcT7PhFZppCXohMwoRdL0cqtmBYTYKX6aVvtNvorTPwJPxC0LS7bjHcmplTYb5iVPUbTPbfTBFUTGiRJfHHiB90OjC0PTDd1bUx6HoSRK6N', 'eWfhdQHYMMLbq9EudVtQLBcde105Pq5dDkJxW66UA0Av0ln4ksW0PtwG3Q66AtpjCJrVLgWVrJNKlRBhXiCwNZ0n0SUR839btyfIR1q6AszpOXI9dlgMzPEIAr11RAXd', '::1', '2019-05-20 03:32:07', '2019-05-20 03:40:46', 0),
(47, 4, 'Cv8otCvjvboSAOaQxBe4ZspMDtPxuHaoY3WWuN4kKONTlCZN3O9VAJa4o9q53aYDI0YsRnvCtHM0mxaCMXnUTrqiEHKvoPeUTXJAQtZ37eDAI4DtTMjRK18jsLUys5Zk', 'ScbNnw1pKO2FV3sPh1rIlilRLfKv3Iv4Tyw16HRcHkgH1jN9PxisG0LK65KvEm1A1lxlGZmzeMKEqjbO0Wzivn9Zu7MB8JZN2JYsqc0xM6FirQdQWhQXV1LzZ9SGhWMM', '::1', '2019-05-20 03:41:04', '2019-05-20 03:49:27', 0),
(48, 13, '5Y1VYkwG9hUYcYCf1SMU2y1A7ccMhzircfTmzKHqX9PK6I8ydkYHTMfUytfKvwr0bLLa428nUna7LEdDNvAniOqtGOimueMXVmtQ23SW1SYyUgiYNGqidPau2axxoeFB', 'q3McKE2cd2V5IPp3sOMbMT4gUv8bfP9sVaYBzWFcWbuzrwYySeRFExtOFgmdPNufynurlqEAdHa5FCv0zMng3oxbQAbNF6owj6fRc1xGvonRKpCcQeFyg20a5KtEiN2d', '::1', '2019-05-20 03:49:36', '2019-05-20 03:49:36', 1);
...
--
ALTER TABLE `job_adv`
  MODIFY `job_adv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `job_adv_location`
  MODIFY `job_adv_location_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `job_apply`
  MODIFY `job_apply_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `reference`
  MODIFY `reference_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `token`
  MODIFY `token_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
COMMIT;
